...
const LoginScreen = ({ navigation, route }) => {
  const { access, setAccess } = useContext(TaskContext);
  ...
  Linking.addEventListener('url', DeepLinking);
    ...
    <View style={styles.container} >
      ...
      <ScrollView>
        <View style={[styles.row, styles.toploginRegistrationButtonContainer]}>
          <View style={[styles.backgroundBlue, styles.flex, styles.toploginRegistrationButton]} uppercase={false} ><Text onPress={() => { navigation.navigate("LoginScreen") }} minimumFontScale={2} style={[styles.textWhite, styles.toploginRegistrationText]}>{t('Prisijungimas')}</Text></View>
          <View style={[styles.background, styles.flex, styles.toploginRegistrationButton]} uppercase={false}><Text style={[styles.textCM, styles.toploginRegistrationText]}>{t('Registracija')}</Text></View>
        </View>
        <View><Text style={[styles.textWhite, styles.LoginText, { paddingTop: 10 }]}>{t('Prie_Scovo_R')}</Text></View>
        <View>
          ...
          <View><Text style={[styles.textWhite1, { paddingTop: 10, textAlign: 'center', paddingBottom: 10 }]}>{t('arba_registruokis')}</Text></View>
