    ...
    return (
        <View style={[styles.container, { backgroundColor: 'white' }]}>
            ...
            <View style={{ flex: 1, paddingLeft: 15, paddingRight: 15, paddingTop: 15, minHeight: 200 }}>
                <Text style={{ marginBottom: 30, marginTop: 20, fontWeight: "700", color: "#1C2F5D" }}>{t("klausimai_kandidatam")}</Text>
                <TextInput
                        value={pareigos}
                        onChangeText={(value) => {
                            if (value.length <= 300) {
                ...
                <CheckBoxList elements={t('reikalingas_CV')} nogrey={true} />
                <CheckBoxList elements={t('reikalingas_Linkedin')} nogrey={true} />
            </View>
            <View >
